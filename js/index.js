    ...
    api: {
        ...
        plupload: function (element, onUploadSuccess, onUploadError, onUploadComplete) {
            ...
            $(element, Upload.config.container).each(function () {
                ...
                //最大可上传文件大小
                maxsize = typeof maxsize !== "undefined" ? maxsize : '';
                //文件类型
                ...
                if (mimetype && mimetype !== "*" && mimetype.indexOf("/") === -1) {
                    ...
                    for (var i = 0; i < tempArr.length; i++) {
                        mimetypeArr.push({title: 'Image files', extensions: tempArr[i]});
                    }
                ...
                Upload.list[id] = new plupload.Uploader({
                    ...
                    init: {
                        ...
                        UploadProgress: function (up, file) {
                            var button = up.settings.button;
                            $(button).prop("disabled", true).html("" + '正在上传' + file.percent + "%");
                ...
                //         },
                //         placeHolderTemplate: '<li class=""></li>'
                //     });
                // }
                if (preview_id && input_id) {
                    $(document.body).on("keyup change", "#" + input_id, function () {
                        ...
                        $.each(inputArr, function (i, j) {
                            ...
                            var html =  `<li class=""><a href="${data.url}" data-url="${data.url}" target="_blank" class="thumbnail"><img src="${data.url}" onerror="this.src='./img/upload_error_03.png';this.onerror=null;" class="img-responsive"></a><a href="javascript:;" class="btn btn-danger btn-xs btn-trash"></a></li>`;
